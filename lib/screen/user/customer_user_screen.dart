...
class CustomerUserScreen extends StatefulWidget {
  @override
  _CustomerUserScreenState createState() => _CustomerUserScreenState();
}

class _CustomerUserScreenState extends State<CustomerUserScreen> implements ViewUserInterface{
  var isLoading = false;
  ...
  void initState() {
    ...
    setState(() {
      isLoading=true;
      viewUserPresenter.doUserListAPI("2",1);
    });
  }
        ...
        children: [
          SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                children: [
                  const Header(title: "Customer Users",type:1),
